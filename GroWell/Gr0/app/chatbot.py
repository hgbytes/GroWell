...
class Chatbot:
    def __init__(self):
        ...
        self.model = "meta-llama/llama-4-scout-17b-16e-instruct"  # Using Llama model which is available on Groq. This model is trained on Italian language. It is recommended to use a model trained on the language of the application.
